export default async function initHighlightJs(rootElement) {
	...
	const bash = await import(/* webpackChunkName: 'hljs', webpackPreload: true */ 'highlight.js/lib/languages/bash');
	const json = await import(/* webpackChunkName: 'hljs', webpackPreload: true */ 'highlight.js/lib/languages/json');
	...
	hljs.registerLanguage('json', bash.default);
